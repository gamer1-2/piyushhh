...
**CampusShield** is a full-stack web application designed to enhance the safety of women on college campuses. It combines real-time communication via WebSockets, AI-powered assistance through Google Gemini, and a secure RESTful backend — all built in TypeScript and deployable as a single monorepo.
