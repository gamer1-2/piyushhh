    ...
    <div class="min-h-screen flex items-center justify-center p-4">
      <div class="auth-card p-8 w-full max-w-md rounded-2xl backdrop-blur-xl">
        <div class="flex items-center gap-3 mb-6">
          ...
          <h1 class="text-2xl font-bold tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">CampusShield</h1>
        </div>
    ...
    <div class="h-screen flex flex-col relative overflow-hidden">
      ...
      <nav class="h-20 border-b border-white/10 bg-black/40 backdrop-blur-xl flex items-center justify-between px-8 z-50 shrink-0">
        <div class="flex items-center gap-3">
          ...
          <h1 class="text-xl font-bold tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">CampusShield</h1>
        </div>
